...
$posters = array("Ready Player One","Rampage","Paddington 2","Hereditary","Alpha","Black Panther","Christopher Robin","Coco","Dunkirk","First Man");
       ...
       <h1> Movie Reviews </h1>
        <div id="main">
           <?php
             ...
             for($i = 0; $i < 4; $i++){
                 sort($posters);
                 foreach ($posters as $key => $val) {
                 echo $val;
             }
                 echo movieReviews($overallRating); 
